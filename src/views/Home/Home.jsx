...
function Home() {
  ...
  const loadTodos = async () => {
    const response = await axios.get(`https://todo-backend-apiss.onrender.com/todos`);
  ...
  const deleteTodo = async (id) => {
    try {
      const response = await axios.delete(`https://todo-backend-apiss.onrender.com/todos/${id}`);
